...
Item {
    ...
    Button{
        ...
        //make also possible to output found primes in different basis to check 10-40-80 period of 1/7 on some other
        ...
        onClicked: {
            ...
            for (var i = 2; i < amount.value; ++i){
                ...
                //console.log(i,'anotherStep',anotherStep)
    ...
    Button{
        y: 250
        text: "Find by spectrum" //yet only for 6
        onPressed: {
            prList.clear()
